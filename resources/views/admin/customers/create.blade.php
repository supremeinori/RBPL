...
<head>
    ...
    <title>Tambah Pelanggan — MR BONGKENG Manage System</title>
    ...
    <div class="main">
        <div class="topbar">
            <div>
                ...
                <div class="topbar-sub">Add a new customer to the database.</div>
            </div>
        ...
        <div class="content">
            <div class="form-card">
                <div class="form-header">
                    <span class="form-title">Informasi Pelanggan Baru</span>
                ...
                <div class="form-body">
                    <form action="{{ route('admin.customers.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_telp" class="form-control" placeholder="08xxxx..." required>
                        </div>
