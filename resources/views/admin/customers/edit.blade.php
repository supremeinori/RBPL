...
<head>
    ...
    <title>Edit Pelanggan — MR BONGKENG Manage System</title>
    ...
    <div class="main">
        <div class="topbar">
            <div>
                ...
                <div class="topbar-sub">Update customer details and address.</div>
            </div>
        ...
        <div class="content">
            <div class="form-card">
                <div class="form-header">
                    <span class="form-title">Update Data Pelanggan</span>
                ...
                <div class="form-body">
                    <form action="{{ route('admin.customers.update', $customer->id_pelanggan) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_telp" class="form-control" value="{{ old('no_telp', $customer->no_telp) }}" required>
                        </div>

                        <div class="form-group">
                            <label class="form-label">Alamat Lengkap</label>
                            <textarea name="alamat" class="form-control" rows="4">{{ old('alamat', $customer->alamat) }}</textarea>
                        </div>
