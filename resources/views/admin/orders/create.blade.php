...
<style>
    ...
    .custom-select-menu { position: absolute; top: 110%; left: 0; width: 100%; background: var(--dark); border: 1px solid var(--border); border-radius: 8px; z-index: 100; box-shadow: 0 4px 15px rgba(0,0,0,0.1); padding-bottom: 8px; }
            ...
            <div class="form-group">
                ...
                <div style="display: flex; gap: 8px;">
                    ...
                    <div class="custom-select-wrapper" id="customSelectWrapper">
                        <div class="custom-select-trigger form-input" onclick="toggleDropdown()">
    ...
    <div class="modal-content">
        ...
        <form id="quick-add-customer-form" onsubmit="event.preventDefault(); submitNewCustomer();">
            <div class="form-group" style="margin-bottom: 12px;">
                ...
                <input type="text" id="qc_nama" required class="form-input" style="padding: 8px;">
            </div>
            <div class="form-group" style="margin-bottom: 12px;">
                <label class="form-label" style="font-size: 12px;">Nomor HP / WhatsApp</label>
                <input type="text" id="qc_hp" required class="form-input" style="padding: 8px;">
            </div>
            <div class="form-group" style="margin-bottom: 16px;">
                <label class="form-label" style="font-size: 12px;">Alamat Lengkap</label>
                <textarea id="qc_alamat" rows="2" required class="form-input" style="padding: 8px;"></textarea>
            </div>
            <div style="display: flex; gap: 8px;">
                <button type="submit" class="btn-primary" style="flex: 1; margin: 0; padding: 10px;">Simpan & Pilih Pelanggan</button>
                <button type="button" onclick="closeAddModal()" class="btn-primary" style="background: var(--mid); box-shadow: none; padding: 10px; margin: 0;">Batal</button>
            </div>
        </form>
    </div>
</div>
