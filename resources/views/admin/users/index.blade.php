...
<head>
    ...
    <title>Kelola User — MR BONGKENG Manage System</title>
    ...
    <div class="main">
        <div class="topbar">
            <div>
                ...
                <div class="topbar-sub">Manage system users and their permissions.</div>
            </div>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th>Email</th>
                                <th>
                                    <a href="{{ request()->fullUrlWithQuery(['sort' => 'role', 'direction' => request('sort') == 'role' && request('direction') == 'asc' ? 'desc' : 'asc']) }}" class="sort-link">
