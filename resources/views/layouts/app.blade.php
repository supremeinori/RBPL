            ...
            <nav class="sidebar-nav">
                ...
                @php
                    ...
                    if (Auth::user()->role === 'admin') {
                        ...
                        $dashboardRoute = route('admin.dashboard');
                        $dashboardLabel = 'Dashboard';
                        $dashboardIcon  = '<path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/><path d="M3 3h18M3 21h18" style="opacity:0"/>';
                ...
                @if(in_array(Auth::user()->role, ['admin', 'superadmin']))
                    ...
                    @if(Auth::user()->role === 'superadmin')
                        ...
                        <a href="{{ route('admin.users.index') }}" class="nav-item {{ Request::is('admin/users*') ? 'active' : '' }}" style="color: #c084fc;">
                        ...
                        <a href="{{ route('admin.backup') }}" class="nav-item {{ Request::is('admin/backup') ? 'active' : '' }}" style="color: #fbbf24;">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
